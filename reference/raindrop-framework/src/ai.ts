...
export const MODEL_CATALOG = [
  ...
  {
    name: 'glm-4.7-ludicrous',
    capability: ['chat'],
    provider: 'external',
    providerModel: 'glm-4.7-ludicrous',
    description: 'External model routed through model-router: glm-4.7-ludicrous',
    rateLimits: {
      requestsPerSecond: 20,
      tokensPerMinute: 2000000
    }
...
/** Model capabilities */
export type ModelCapability = 'chat' | 'embeddings' | 'audio' | 'tts' | 'pii-detection' | 'image-generation' | 'text-classification' | 'image-classification' | 'translation' | 'summarization' | 'vision' | 'reranker';
...
export interface AudioInput {
  ...
  sample_rate?: number; // For streaming models (e.g., flux) - audio sample rate in Hz
  encoding?: string; // For streaming models (e.g., flux) - audio encoding format (e.g., 'linear16')
}
...
export type AiInput2 = (InputQueryAndContexts | InputEmbedding | {
/**
...
export type AiOutput2 = (OutputQuery | OutputEmbeddingForContexts | OutputEmbedding)
...
export interface OutputEmbedding {
shape?: number[]
/**
...
export type AiInput4 = (Prompt | Messages)
...
type _cf_baai_bge_m3_Input = AiInput2;
type _cf_huggingface_distilbert_sst_2_int8_Input = AiInput3;
type _cf_google_gemma_2b_it_lora_Input = AiInput4;
type _cf_meta_llama_3_8b_instruct_Input = AiInput4;
type _cf_meta_llama_3_2_3b_instruct_Input = AiInput4;
type _cf_meta_llama_guard_3_8b_Input = AiInput5;
type _cf_qwen_qwen3_embedding_0_6b_Input = AiInput6;
type _cf_meta_llama_2_7b_chat_fp16_Input = AiInput4;
type _cf_mistral_mistral_7b_instruct_v0_1_Input = AiInput4;
type _cf_myshell_ai_melotts_Input = AiInput7;
type _cf_mistral_mistral_7b_instruct_v0_2_lora_Input = AiInput4;
...
type _hf_mistral_mistral_7b_instruct_v0_2_Input = AiInput4;
type _cf_llava_hf_llava_1_5_7b_hf_Input = AiInput11;
type _cf_deepseek_ai_deepseek_r1_distill_qwen_32b_Input = AiInput4;
...
type _cf_meta_llama_2_7b_chat_int8_Input = AiInput4;
type _cf_meta_llama_3_1_8b_instruct_fp8_Input = AiInput4;
type _cf_meta_llama_3_2_1b_instruct_Input = AiInput4;
type _cf_microsoft_resnet_50_Input = AiInput16;
type _cf_bytedance_stable_diffusion_xl_lightning_Input = AiInput12;
type _cf_meta_llama_llama_2_7b_chat_hf_lora_Input = AiInput4;
type _cf_meta_llama_3_3_70b_instruct_fp8_fast_Input = AiInput17;
type _cf_ibm_granite_granite_4_0_h_micro_Input = AiInput4;
...
type _hf_nousresearch_hermes_2_pro_mistral_7b_Input = AiInput4;
...
type _cf_defog_sqlcoder_7b_2_Input = AiInput4;
type _cf_microsoft_phi_2_Input = AiInput4;
...
type _hf_google_gemma_7b_it_Input = AiInput4;
...
type glm_4_6_ludicrous_Input = AiInput57;
type glm_4_7_ludicrous_Input = AiInput58;
type glm_4_6_Input = AiInput59;

/** Generated output types for all AI models */
type _cf_pipecat_ai_smart_turn_v2_Output = AiOutput;
type _cf_baai_bge_m3_Output = AiOutput2;
type _cf_huggingface_distilbert_sst_2_int8_Output = AiOutput3;
type _cf_google_gemma_2b_it_lora_Output = AiOutput4;
type _cf_meta_llama_3_8b_instruct_Output = AiOutput4;
type _cf_meta_llama_3_2_3b_instruct_Output = AiOutput4;
type _cf_meta_llama_guard_3_8b_Output = AiOutput5;
type _cf_qwen_qwen3_embedding_0_6b_Output = AiOutput6;
type _cf_meta_llama_2_7b_chat_fp16_Output = AiOutput4;
type _cf_mistral_mistral_7b_instruct_v0_1_Output = AiOutput4;
type _cf_myshell_ai_melotts_Output = AiOutput7;
type _cf_mistral_mistral_7b_instruct_v0_2_lora_Output = AiOutput4;
...
type _hf_mistral_mistral_7b_instruct_v0_2_Output = AiOutput4;
type _cf_llava_hf_llava_1_5_7b_hf_Output = AiOutput11;
type _cf_deepseek_ai_deepseek_r1_distill_qwen_32b_Output = AiOutput4;
...
type _cf_meta_llama_2_7b_chat_int8_Output = AiOutput4;
type _cf_meta_llama_3_1_8b_instruct_fp8_Output = AiOutput4;
type _cf_meta_llama_3_2_1b_instruct_Output = AiOutput4;
type _cf_microsoft_resnet_50_Output = AiOutput16;
type _cf_bytedance_stable_diffusion_xl_lightning_Output = AiOutput12;
type _cf_meta_llama_llama_2_7b_chat_hf_lora_Output = AiOutput4;
type _cf_meta_llama_3_3_70b_instruct_fp8_fast_Output = AiOutput17;
type _cf_ibm_granite_granite_4_0_h_micro_Output = AiOutput4;
...
type _cf_qwen_qwen2_5_coder_32b_instruct_Output = AiOutput4;
type _hf_nousresearch_hermes_2_pro_mistral_7b_Output = AiOutput4;
...
type _cf_defog_sqlcoder_7b_2_Output = AiOutput4;
type _cf_microsoft_phi_2_Output = AiOutput4;
...
type _hf_google_gemma_7b_it_Output = AiOutput4;
...
type glm_4_7_ludicrous_Output = AiOutput31;
...
export type AiModelInputMap = {
  [K in AvailableModel]:
    ...
    K extends 'bge-reranker-base' ? RerankerInput :
    ...
    K extends 'distilbert-sst-2-int8' ? TextClassificationInput :
    ...
    K extends 'llama-3.3-70b' | 'llama-4-maverick-17b' | 'llama-3.1-8b-external' | 'deepseek-r1' | 'deepseek-v3-0324' | 'deepseek-v3.1' | 'deepseek-v3.1-terminus' | 'deepseek-r1-distill-llama-70b' | 'qwen-3-32b' | 'llama-3.3-swallow-70b' | 'gpt-oss-120b' | 'llama-3.1-8b-instant' | 'llama-guard-4-12b' | 'kimi-k2' | 'gpt-oss-20b' | 'glm-4.6-ludicrous' | 'glm-4.7-ludicrous' | 'glm-4.6' ? OpenAIChatInputExternal :
    OpenAIChatInput;
};
...
export type AiModelOutputMap = {
  [K in AvailableModel]:
    ...
    K extends 'bge-reranker-base' ? RerankerOutput :
    ...
    K extends 'distilbert-sst-2-int8' ? TextClassificationOutput :
